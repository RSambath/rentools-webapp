...
function ItemInfo() {
    ...
    return (
        <div className='h-[200em] w-4/5 m-auto'>
            <div className='w-full bg-slate-500 font-bold text-start p-[1.5em] my-10 text-white text-2xl'>{item.tool_name}
            </div>
            <div className='flex'>
                ...
                <div className='p-5 shadow-md ml-4 w-[35%]'>
                    ...
                    <div className='mb-5 w-full'>
                        ...
                        <div className='w-full'>
                            <input type="date" /> {/* Input element to get the start date */}
                            <DatePicker
